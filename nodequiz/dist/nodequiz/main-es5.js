...
var DashboardComponent = /** @class */ (function () {
    function DashboardComponent(router, cookie) {
        this.router = router;
        this.cookie = cookie;
    }
    ...
    LoginComponent.prototype.login = function () {
        ...
        this.http.get('/api/employees/' + employeeId).subscribe(function (res) {
            if (res) {
                ...
                _this.errorMessage = "Invalid, please try again.";
            }
        });
    };
...
var NotFoundComponent = /** @class */ (function () {
    function NotFoundComponent(route, location) {
        this.route = route;
...
var PresentationComponent = /** @class */ (function () {
    ...
    PresentationComponent.prototype.goToQuiz = function (quizId) {
        this.quizId = quizId;
        console.log(quizId);
...
var QuizComponent = /** @class */ (function () {
    function QuizComponent(route, cookieService, location, dialog, http, quizService, router) {
        var _this = this;
        this.route = route;
        this.cookieService = cookieService;
        this.location = location;
    ...
    QuizComponent.prototype.onSubmit = function (form) {
        ...
        this.quiz = this.quizzes.filter(function (q) { return q.id === _this.quizId; });
        var questionCount = this.quiz.questions;
        var pointsPerQusetions = totalPossiblePoints / questionCount;
        var quizScore = 0;
            ...
            for (var prop in _this.quizResults) {
                if (_this.quizResults.hasOwnProperty(prop)) {
                    if (prop !== 'employeeId' && prop !== 'quizId') {
                        selectedAnswerIds.push(_this.quizResults[prop].split(';')[0]);
                        selectedisCorrectProp.push(_this.quizResults[prop].split(';')[1]);
                    }
                }
            }
        });
        var dialogRef = this.dialog.open(src_app_shared__WEBPACK_IMPORTED_MODULE_8__["ResultsComponent"], {
            data: {}
        });
        /* this.quizResults = form;
...
var ResultsComponent = /** @class */ (function () {
    // resultsDisplay: any;
    function ResultsComponent(dialogRef, router, cookieService) {
...
var HeaderComponent = /** @class */ (function () {
    function HeaderComponent(router, cookie) {
        this.router = router;
        this.cookie = cookie;
    }
...
var QuizSummaryDialogComponent = /** @class */ (function () {
    ...
    QuizSummaryDialogComponent.prototype.ngOnInit = function () {
    };
